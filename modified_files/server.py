...
DIRECT_ONLINE_API = os.environ.get('DIRECT_ONLINE_API', 'https://agency-dashboard-61.preview.emergentagent.com/api')
...
async def get_admin_redirect():
    ...
    return {
        "redirect_url": "https://agency-dashboard-61.preview.emergentagent.com",
